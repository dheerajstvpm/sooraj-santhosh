    ...
    <nav className="bg-gray-100 dark:bg-gray-900 p-4 shadow-md">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <ul className="flex space-x-4">
          ...
          <li>
            <Link href="/music" className="text-gray-700 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400">
              Music
            </Link>
          </li>
          <li>
            <Link href="/videos" className="text-gray-700 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400">
              Videos
            </Link>
          </li>
          <li>
