...
1.  Generate the static build:
    ...
    pnpm export
    ```
    This will create a `out` directory containing the static HTML, CSS, and JavaScript files, ready for deployment.

### Deployment
The static `out` directory can be deployed to platforms like GitHub Pages. Specific configuration for GitHub Pages will be handled during the deployment phase.
